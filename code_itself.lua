...
if placeID == 18629062294 then
    ...
    main:CreateSubDivider('civilization teleports')
    
    -- Helper function to convert string coordinates to CFrame
    ...
    local EMERALD = "-370, 83, 590"
    local PINK_DIM = "-612, -35, 172"
    local OLD_GOOD = "-377, 13, 679"
    local DOCK = "14, -150, -12"
    local CRY = "-85, 1, -1216"
    local VOID = "-395, -7, -33"
    local EMCAVE = "-357, -53, 490"
    local ANC_TREE = "-405, 94, 6"

    -- Button for ancient tree
    main:CreateButton("ancient tree", function()
        local targetCFrame = stringToCFrame(ANC_TREE)
        local tolerance = 0.5
        local teleportDelay = 0.000001
    ...
    -- Button for emerald cave
    main:CreateButton("emerald cave", function()
        local targetCFrame = stringToCFrame(EMCAVE)
        local tolerance = 0.5
        local teleportDelay = 0.000001
        local teleportDuration = 2
    ...
    main:CreateButton("void", function()
        local targetCFrame = stringToCFrame(VOID)
        local tolerance = 0.5
        local teleportDelay = 0.000001
        local teleportDuration = 2
    ...
    main:CreateButton("crystal", function()
        local targetCFrame = stringToCFrame(CRY)
        local tolerance = 0.5
        local teleportDelay = 0.000001
        local teleportDuration = 2
    ...
    -- Button for dock
    main:CreateButton("dock", function()
        local targetCFrame = stringToCFrame(DOCK)
        local tolerance = 0.5
        local teleportDelay = 0.000001
        local teleportDuration = 2
    ...
    -- Button for pink diamond
    main:CreateButton("pink diamond", function()
        local targetCFrame = stringToCFrame(PINK_DIM)
        local tolerance = 0.5
        local teleportDelay = 0.000001
        local teleportDuration = 2
    ...
    -- Button for old good
    main:CreateButton("old g", function()
        local targetCFrame = stringToCFrame(OLD_GOOD)
        local tolerance = 0.5
        local teleportDelay = 0.000001
        local teleportDuration = 2
...
if placeID == 18629053284 then
    ...
    main:CreateSubDivider("normal teleports")

    -- Helper function to convert string coordinates to CFrame
    local function stringToCFrame(coordString)
        local x, y, z, cx, cy, cz, ax, ay, az = coordString:match("([^,]+),%s*([^,]+),%s*([^,]+),%s*([^,]*),%s*([^,]*),%s*([^,]*),%s*([^,]*),%s*([^,]*),%s*([^,]*)")
        if x and y and z then
            return CFrame.new(tonumber(x), tonumber(y), tonumber(z), tonumber(cx) or 0, tonumber(cy) or 0, tonumber(cz) or 0, tonumber(ax) or 0, tonumber(ay) or 0, tonumber(az) or 0)
        else
            return CFrame.new(tonumber(x), tonumber(y), tonumber(z))
        end
    end
    ...
    -- Button for overgrown good location
    main:CreateButton("overgrown g", function()
    ...
    -- Button for miserable good location
    main:CreateButton("miserable g", function()
    ...
    -- Button for frozen good location
    main:CreateButton("frozen g", function()
        local targetCFrame = stringToCFrame(FROZEN_GOOD)
        local tolerance = 0.5
        local teleportDelay = 0.000001
        local teleportDuration = 2
    ...
    -- Button for hateful good location
    main:CreateButton("hateful g", function()
    ...
    -- Button for peace island location
    main:CreateButton("peace island", function()
    ...
    -- Button for island location
    main:CreateButton("island", function()
    ...
    -- Button for gold island location
    main:CreateButton("gold island", function()
    ...
    -- Button for crystal island location
    main:CreateButton("crystal island", function()
    ...
    -- Button for magnetite cave location
    main:CreateButton("magnetite cave", function()
    ...
    -- Button for emerald cave location
    main:CreateButton("emerald cave", function()
        local targetCFrame = stringToCFrame(EMERALD)
        local tolerance = 0.5
        local teleportDelay = 0.000001
    ...
    -- Button for pink diamond island location
    main:CreateButton("pink diamond island", function()
